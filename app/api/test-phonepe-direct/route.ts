...
// This is a direct test of the PhonePe API without any abstractions
export async function GET() {
  try {
    ...
    const payload = {
      ...
      redirectUrl: `${baseUrl}/payment/phonepe-callback?test=true`,
    ...
    console.error("Direct PhonePe test error:", error)
    return NextResponse.json(
      {
        success: false,
