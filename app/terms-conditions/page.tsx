...
export const metadata = {
  title: "Terms & Conditions | XDigitalHub",
    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto py-10 px-4 md:px-6">
        <Card className="border-blue-100 max-w-4xl mx-auto">
          <CardHeader>
            <CardTitle className="text-3xl font-bold blue-gradient-text">Terms & Conditions</CardTitle>
            <p className="text-sm text-gray-500">Last updated on 25-04-2025 20:04:48</p>
          </CardHeader>
          <CardContent className="prose max-w-none">
            <p>
              These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding
              agreement by and between Deepa, ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and
              relate to your use of our website, goods (as applicable) or services (as applicable) (collectively,
              "Services").
            </p>
